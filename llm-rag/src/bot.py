...
async def create_pipeline_task(pipeline_metadata: PipelineMetadata):
    ...
    with tracer.start_as_current_span("ace-pipeline", context=trace_context) as span:
        ...
        stt = OpenAISTTService(
            ...
            prompt="""Transcribe spoken Hindi clearly and accurately. 
                    Preserve technical and domain-specific terms as-is. Use numerals for all numbers (e.g., 100 instead of सौ).
                    Maintain punctuation and sentence structure as per natural spoken flow."""
        )
