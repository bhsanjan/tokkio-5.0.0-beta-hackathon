...
class Pipeline(BaseModel):
    llm_processor: Literal["NvidiaRAGService", "NvidiaLLMService", "OpenAILLMService", "NvidiaAIQService"]
    filler: list[str] = [
        "Let me think",
        "Hmmm"
    ]
...
class NvidiaRAGService(BaseModel):
    ...
    suffix_prompt: str = ""
class NvidiaAIQService(BaseModel):
    aiq_server_url: str  
    use_knowledge_base: bool = True
    max_tokens: int = 1000 
...
class Config(BaseModel):
    ...
    NvidiaAIQService: NvidiaAIQService
